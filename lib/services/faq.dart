...
List faqs = [
  ...
  },
  {
    ...
    "answer": "1. Access the project module on the dashboard. Or open the side"
        ...
        "later)</bold>. \n\n7. Click the <bold>Add site ➕ button</bold> to add a new site. <bold>Note:</bold> "
        "You can add multiple sites by clicking <bold>Add site ➕ button</bold> before you "
